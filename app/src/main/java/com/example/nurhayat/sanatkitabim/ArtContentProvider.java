/* package com.example.nurhayat.sanatkitabim;
...
public class ArtContentProvider extends ContentProvider {
    ...
    static final String PROVIDER_NAME ="com.example.nurhayat.sanatkitabim.ArtContentProvider";
    ...
    //static final UriMatcher uriMatcher; böyle olması gerekiyor ama hata veriyor
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper {
        ...
        @Override
        public void onCreate(SQLiteDatabase db) {  // database helper çağırıldıgında helper sınıfını çagır tablolarım
    ...
    @Override
    public int delete(@NonNull Uri uri, @Nullable String selecion, @Nullable String[] selectionArgs) {


        int rowCount = 0 ;
        switch (uriMatcher.match(uri)) {
            case ARTS:
                sqLiteDatabase.delete(ARTS_TABLE_NAME,selecion,selectionArgs);
                break;
            default:
